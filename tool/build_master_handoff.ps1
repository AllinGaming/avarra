...
$sourcePaths = @(
    ...
    'docs/AVARRA_STAGE_12_52_DROWNED_SIGNAL_AND_COMBAT_RHYTHM_VALIDATION.md'
    'docs/AVARRA_STAGE_12_53_FIXED_STEP_PRESENTATION_SMOOTHING_VALIDATION.md'
    'docs/AVARRA_STAGE_12_54_BOSS_HUD_VALIDATION.md'
    'docs/AVARRA_STAGE_12_55_CAMERA_LOOKAHEAD_VALIDATION.md'
    'docs/AVARRA_STAGE_12_56_AUTHORED_RELIC_REWARD_FEEDBACK_VALIDATION.md'
    'docs/AVARRA_STAGE_12_57_TRANSIENT_NOTICE_LANE_VALIDATION.md'
    'docs/AVARRA_STAGE_12_58_PERSISTENT_CHARACTER_POWER_VALIDATION.md'
    'docs/AVARRA_STAGE_12_59_CHARACTER_POWER_ACCESS_AND_FUTURE_PLAN_VALIDATION.md'
    'docs/AVARRA_STAGE_12_60_AUTHORITY_OWNED_RELIC_MEND_VALIDATION.md'
    'docs/AVARRA_STAGE_12_61_EXPORTABLE_PLAYTEST_EVIDENCE_VALIDATION.md'
    'docs/AVARRA_GAME_FUTURE_PASSES.md'
    ...
    'docs/adr/ADR-039-built-in-authority-owned-relic-mend.md'
)
